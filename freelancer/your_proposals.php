...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['createOfferBtn'])) {
    $offer = new Offer();
    $result = $offer->createOffer($_SESSION['user_id'], $_POST['description'], $_POST['proposal_id']);
          ...
          <div class="card-body">
            ...
            <form action="" method="POST" class="mt-3">
              ...
              <div class="form-group">
                ...
                <textarea name="description" class="form-control" placeholder="Write your offer details..." required></textarea>
              </div>
              <input type="submit" name="createOfferBtn" class="btn btn-success" value="Send Offer">
            </form>
